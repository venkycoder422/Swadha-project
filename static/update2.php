...
if(isset($_POST["SubM3"])) {
	$nooCC=$_POST['nooCC'];
$pmppUd=$_POST['pmppUd'];
 $sql23 = "UPDATE livestock
        SET livestockname='$nooCC',private_price='$pmppUd'
        WHERE id = $id;";
		$conn->query($sql23);
...
$sql8="SELECT * FROM livestock WHERE id=$id";
...
?>
<tr id='adddr0'>
<td><input type="text" name="nooCC"   class='wid' value=<?php echo $lsinfo["livestockname"];?>></td>
<td><input type="text" name="pmppUd"  class='wid' value=<?php echo $lsinfo["private_price"];?>></td>
</tr>
<?php
...
?>
							...
							<button name="SubM3" type="Submit" class="btn btn-primary btn-lg">Update</button>
						</div>
