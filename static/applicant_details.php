									...
									<div class="row d-flex justify-content-center">
										...
										<div class="col-md-12">
											...
											<div class="wizard">
												...
												<form role="form"  class="login-box" method="post" id="applicant_details">
													...
													<div id="main_form">
															...
															<div class="form-2"	>
																		...
																		<div class="row">
																				...
																				<div class="col-md-6 col-sm-12">
																					...
																					<input type="text" class="form-control mb-3" placeholder="" id="id1" name="id1">
																				...
																				<div class="col-md-6 col-sm-12">
																					...
																					<input type="text" class="form-control mb-3" placeholder="" id="id2" name="id2">
															...
															<div class="row mt-3">
																...
																<ul class="list-inline pull-right">
																	...
																	<li><button type="button" class="default-btn btn-primary  next-step">Continue to next
																	step</button></li>
