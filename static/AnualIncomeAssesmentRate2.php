...
<!--<form role="form" id="myform" class="login-box" method="post">
												...
												<div class="card">									
																...
																<div class="card-body" style="border-bottom: 1px solid #dddddd;margin-bottom: 40px;">
																	 ...
																	 <div class="row">
																				...
																				<input type="text" id="appNo" name="appNo" style="width: 100%;height: 34px;">
																				...
																				<button name="SubM" id="osx" class="btn btn-primary btn-lg">Submit</button>
														 ...
														 <div class="row">
														 	<div class="col-md-4 col-sm-12 centertext">
														 		<div class="circle" style="background-color:<?php echo $_SESSION['m'];?>">Method 1</div>
														 		<div class="dshl" style="background-color:<?php echo $_SESSION['m'];?>"></div>
														 
														 <p class="h3 mb-3" style=" font-size: 15px;">Informal income Rs. <?php echo $_SESSION['a'];?>	</p>
														<p class="h3 mb-3" style=" font-size: 15px;"> Formal income Rs. <?php echo $_SESSION['b'];?>	</p>

														<p class="h3 mb-3" style=" font-size: 15px;"> Income from crops in Rs. <?php echo $_SESSION['c'];?>	</p>
														<p class="h3 mb-3" style=" font-size: 15px;"> Income from livestocs in Rs. <?php echo $_SESSION['h'];?>	</p>

														<p class="h3 mb-3" style=" font-size: 15px;"> Income from rented items in Rs. <?php echo $_SESSION['g'];?>	</p>
					
														 	</div>
														 	<div class="col-md-4 col-sm-12 centertext">
														 		<div class="circle" style="background-color:<?php echo $_SESSION['n'];?>">Method 2</div>
														 		<div class="dshl" style="background-color:<?php echo $_SESSION['n'];?>"></div>
														 		<p class="h3 mb-3" style=" font-size: 15px;"> Average annual income per family member in Rs. <?php echo $_SESSION['trus2'];?>	</p>

														 	</div>
														 	<div class="col-md-4 col-sm-12 centertext">
														 		<div class="circle" style="background-color:<?php echo $_SESSION['o'];?>">Method 3</div>
														 		<div class="dshl" style="background-color:<?php echo $_SESSION['o'];?>"></div>
														 		<p class="h3 mb-3" style=" font-size: 15px;"> Total annual expenses in Rs. <?php echo $_SESSION['te'];?>	</p>
...
window.onload = function() {
 ...
 console.log(session);
 document.getElementById('appNo').value=session.appid;
};
